...
if (isset($_GET['nombre_modulo']) == true &&  $_GET['nombre_modulo']  != "") {
	$filtros .= " AND m.modulo = '$_GET[nombre_modulo]' ";
}

if (isset($_GET['nombre_accion']) == true &&  $_GET['nombre_accion']  != "") {
	 $filtros .= " AND m.accion = '$_GET[nombre_accion]' ";
 }


					$s= "SELECT m.id_modulo_accion, m.modulo, m.accion        
                                     
					FROM modulo_accion as m 
					WHERE TRUE $filtros
					...
					<tr>
						...
						<td class='acciones'>
	                    <a href='javascript:;' class='mostrar'  onclick='mostrar(\"$rw[id_modulo_accion]\")'>
	                        <i class='fas fa-eye'></i>
	                    </a>
	                    <a href='javascript:;' class='eliminar' onclick='eliminar(\"$rw[id_modulo_accion]\")'>
	                        <i class='fas fa-trash'></i>
	                    </a>
	                    <a href='javascript:;' class='modificar' onclick='modificar(\"$rw[id_modulo_accion]\")'>
