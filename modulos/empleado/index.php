        ...
        <div class="card" style="width:750px;margin:auto">
            ...
            <div class="card-body" style="border:0px red solid">
                <form action="guardar.php" method="post" id="formulario" autocomplete="off">
                    <div class="text-center bg-info" style="color:#FFF;">
                        <h6 style="padding:5px">EMPLEADO</h6>
                    </div>
...
//____________________BOTON MODIFICAR_________________________________
        ...
        function mostrar(id_empleado) {
            ...
            var parametros = "id_empleado=" + id_empleado;
            $.get("?modulo=empleado&accion=cargar-datos", parametros, function(respuesta) {
                $("#formulario")[0].reset(); //limpiar formulario
        ...
        function eliminar(id_empleado) {
            if (confirm("¿Realmente desea eliminar el registro?")) {
                var parametros = "id_empleado=" + id_empleado;
                $.post("?modulo=empleado&accion=eliminar", parametros, function(respuesta) {
                    var r = jQuery.parseJSON(respuesta);
                    alert(r.mensaje);
                    if (r.error == false) {
                        cargar_listado();
