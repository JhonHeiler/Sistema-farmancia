...
$sql_cantidad = "SELECT count(*) as cantidad FROM empleado";
		...
		<table id="table" class="table table-striped" >
			...
			<tbody>
		        ...
		        if (isset($_GET['id_empleado']) == true &&  $_GET['id_empleado']  != "") {
		            $filtros .= " AND e.id_empleado = '$_GET[id_empleado]' ";
		        }


		         if (isset($_GET['nombre']) == true &&  $_GET['nombre']  != "") {
		             $filtros .= " AND e.nombre = '$_GET[nombre]' ";
					...
					<tr>
						...
						<td class='acciones'>
	                    <a href='javascript:;' class='mostrar'  onclick='mostrar(\"$rw[id_empleado]\")'>
	                        <i class='fas fa-eye'></i>
	                    </a>
	                    <a href='javascript:;' class='eliminar' onclick='eliminar(\"$rw[id_empleado]\")'>
	                        <i class='fas fa-trash'></i>
	                    </a>
	                    <a href='javascript:;' class='modificar' onclick='modificar(\"$rw[id_empleado]\")'>
