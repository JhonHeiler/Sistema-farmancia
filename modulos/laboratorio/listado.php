...
$sql_cantidad = "SELECT count(*) as cantidad FROM laboratorio";
		...
		<table id="table" class="table table-striped" >
			...
			<tbody>
		        ...
		        if (isset($_GET['id_laboratorio']) == true &&  $_GET['id_laboratorio']  != "") {
		            $filtros .= " AND l.id_laboratorio = '$_GET[id_laboratorio]' ";
		        }


		         if (isset($_GET['nombre_laboratorio']) == true &&  $_GET['nombre_laboratorio']  != "") {
		             $filtros .= " AND l.nombre_laboratorio = '$_GET[nombre_laboratorio]' ";
		         }
					...
					<tr>
						...
						<td class='acciones'>
	                    <a href='javascript:;' class='mostrar'  onclick='mostrar(\"$rw[id_laboratorio]\")'>
	                        <i class='fas fa-eye'></i>
	                    </a>
	                    <a href='javascript:;' class='eliminar' onclick='eliminar(\"$rw[id_laboratorio]\")'>
	                        <i class='fas fa-trash'></i>
	                    </a>
	                    <a href='javascript:;' class='modificar' onclick='modificar(\"$rw[id_laboratorio]\")'>
