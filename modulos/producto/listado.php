		...
		<table id="table" class="table table-striped" >
			...
			<tbody>
				<?php 
		         ...
		         if (isset($_GET['id_laboratorio']) == true &&  $_GET['id_laboratorio']  != "") {
		             $filtros .= " AND p.id_laboratorio = '$_GET[id_laboratorio]' ";
		         }

		          if (isset($_GET['id_tipo_presentacion']) == true &&  $_GET['id_tipo_presentacion']  != "") {
		             $filtros .= " AND t.id_tipo_presentacion = '$_GET[id_tipo_presentacion]' ";
		         }
					...
					p.id_pedido,
					p.id_laboratorio,
					p.id_tipo_presentacion, 
					 p.nombre_producto,
					 p.descripcion, 
					 p.fecha, 
					 p.lote_producto, 
					 t.nombre_tipo_presentacion as nombre_presentacion, 
					 l.nombre_laboratorio from producto as p 
					 inner join tipo_presentacion as t on p.id_tipo_presentacion = t.id_tipo_presentacion
					...
					<tr>
						...
						<td>$rw[nombre_producto]</td>
						<td>$rw[descripcion]</td>
						<td>$rw[fecha]</td>	
						<td>$rw[nombre_presentacion]</td>					
						<td>$rw[nombre_laboratorio]</td>
						<td>$rw[lote_producto]</td>
						
						<td class='acciones'>
	                    <a href='javascript:;' class='mostrar'  onclick='mostrar(\"$rw[id_producto]\")'>
	                        <i class='fas fa-eye'></i>
	                    </a>
	                    <a href='javascript:;' class='eliminar' onclick='eliminar(\"$rw[id_producto]\")'>
	                        <i class='fas fa-trash'></i>
	                    </a>
	                    <a href='javascript:;' class='modificar' onclick='modificar(\"$rw[id_producto]\")'>
