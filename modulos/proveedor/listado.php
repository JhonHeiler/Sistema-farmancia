...
$sql_cantidad = "SELECT count(*) as cantidad FROM proveedor";
		...
		<table id="table" class="table table-striped" >
			...
			<tbody>
		        ...
		        if (isset($_GET['id_proveedor']) == true &&  $_GET['id_proveedor']  != "") {
		            $filtros .= " AND p.id_proveedor = '$_GET[id_proveedor]' ";
		        }
		         ...
		         if (isset($_GET['nombre']) == true &&  $_GET['nombre']  != "") {
		          ...
		          if (isset($_GET['telefono']) == true &&  $_GET['telefono']  != "") {
					...
					<tr>
						...
						<td class='acciones'>
	                    <a href='javascript:;' class='mostrar'  onclick='mostrar(\"$rw[id_proveedor]\")'>
	                        <i class='fas fa-eye'></i>
	                    </a>
	                    <a href='javascript:;' class='eliminar' onclick='eliminar(\"$rw[id_proveedor]\")'>
	                        <i class='fas fa-trash'></i>
	                    </a>
	                    <a href='javascript:;' class='modificar' onclick='modificar(\"$rw[id_proveedor]\")'>
