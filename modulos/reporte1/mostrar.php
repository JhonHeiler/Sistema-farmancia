...
$sql = "SELECT p.nombre_producto as nombre, p.descripcion, p.fecha, p.lote_producto, l.nombre_laboratorio, pre.nombre_tipo_presentacion FROM producto as p inner join laboratorio as l on p.id_laboratorio = l.id_laboratorio inner join tipo_presentacion pre on p.id_tipo_presentacion = pre.id_tipo_presentacion
...
<table style="font-family:'Times New Roman', Times, serif; font-size:8pt; 
    ...
    <thead>
        <tr style="font-weight:bold; text-align:left; background-color:#e1e1e1">
            ...
            <th style="width:30mm">Descripcion</th>
            <th style="width:30mm">Fecha</th>
            <th style="width:30mm">Lote Producto</th>
            <th style="width:30mm">Laboratorio</th>
            <th style="width:30mm">Presentacion</th>
    ...
    <tbody>
        ...
        while ($row = mysqli_fetch_assoc($rs))
            ...
            echo "<td style=\"width:30mm;\">$row[descripcion]</td>";
            echo "<td style=\"width:30mm;\">$row[fecha]</td>";
             echo "<td style=\"width:30mm;\">$row[lote_producto]</td>";
              echo "<td style=\"width:30mm;\">$row[nombre_laboratorio]</td>";       
             echo "<td style=\"width:30mm;\">$row[nombre_tipo_presentacion]</td>";
