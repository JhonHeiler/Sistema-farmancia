<div id="" class="content mt-5 mb-5" style="width:700px; margin:auto; ">
    ...
    <div class="card">
        <div class="card-header">
            <h4 id="titulo">Productos por su nombre</h4>

        </div>

        <div class="card-body">
            <form id="formulario" method="post" target="_blank" action="?modulo=reporte11&accion=mostrar">

                <div class="form-group row">
                    <label for="id_producto" class="col-sm-3 col-form-label">Tipo de presentacion</label>
                    <div class="col-sm-9">
