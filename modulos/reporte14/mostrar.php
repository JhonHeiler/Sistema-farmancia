...
<table style="font-family:'Times New Roman', Times, serif; font-size:13pt; 
       border-collapse:collapse" cellpadding="2" cellspacing="0">
    <thead>
        <tr style="font-weight:bold; text-align:right; background-color:#e1e1e1">
            <th style="width:80mm">No</th>
            <th style="width:90mm">Cantidad De Productos</th>
