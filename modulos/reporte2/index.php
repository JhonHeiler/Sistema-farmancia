<div id="" class="content mt-5 mb-5" style="width:700px; margin:auto; ">
    ...
    <div class="card">
        <div class="card-header">
            <h4 id="titulo">Listado de producto por presentaciones</h4>
        ...
        <div class="card-body">
            <form id="formulario" method="post" target="_blank" action="?modulo=reporte2&accion=mostrar">
                ...
                <div class="form-group row">
                    <label for="id_tipo_presentacion" class="col-sm-3 col-form-label">Tipo de presentacion</label>
                    <div class="col-sm-9">
                        <select class="form-control " id="id_tipo_presentacion" name="id_tipo_presentacion">
                            <option value="">(SELECIONAR PRESENTACION)</option>
                            <?php
                            $sql2 = "SELECT * from tipo_presentacion  ORDER BY  nombre_tipo_presentacion";
