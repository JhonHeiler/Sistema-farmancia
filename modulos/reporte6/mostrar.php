...
$sql = "SELECT concat_ws(' ',p.nombre,p.apellido) as nombre, p.telefono, p.correo, p.ciudad from proveedor p
...
<table style="font-family:'Times New Roman', Times, serif; font-size:9pt; 
    ...
    <thead>
        <tr style="font-weight:bold; text-align:left; background-color:#e1e1e1">
            ...
            <th style="width:80mm">Nombre</th>
            <th style="width:30mm">Telefono</th>
            <th style="width:40mm">Correo</th>
            <th style="width:30mm">Ciudad</th>
    ...
    <tbody>
        ...
        while ($row = mysqli_fetch_assoc($rs))
            ...
            echo "<td style=\"width:80mm;\">$row[nombre]</td>";
            echo "<td style=\"width:30mm;\">$row[telefono]</td>";
            echo "<td style=\"width:40mm;\">$row[correo]</td>";
             echo "<td style=\"width:30mm;\">$row[ciudad]</td>";
