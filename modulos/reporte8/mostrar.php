...
$sql = "SELECT concat_ws(' ', p.nombre, p.apellido) as nombre, rol.nombre FROM persona as p inner JOIN persona_rol as pe on p.id_persona = pe.id_persona inner JOIN rol on pe.id_rol = rol.id_rol
...
<table style="font-family:'Times New Roman', Times, serif; font-size:12pt; 
    ...
    <thead>
        <tr style="font-weight:bold; text-align:center; background-color:#e1e1e1">
            ...
            <th style="width:153mm">Nombre laboratorio</th>
    ...
    <tbody>
        ...
        while ($row = mysqli_fetch_assoc($rs))
            ...
            echo "<td style=\"width:153mm;\">$row[nombre]</td>";
