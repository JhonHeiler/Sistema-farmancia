                    ...
                    <br>
                     ...
                     <div class="form-group row">
                        <div class="col-sm-12 col-md-4">
                            <label for="tipo_sexo">TIPO DE SEXO *</label>
                        </div>
                        <div class="col-sm-12 col-md-8">
                            <input type="text" name="tipo_sexo" id="" class="form-control" placeholder="" aria-describedby="helpId">
                        </div>
                    </div>
            ...
            <div class="card-body" style="border:0px red solid">
                <form action="guardar.php" method="post" id="formulario" autocomplete="off">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-12 col-md-8">
                            <input type="text" name="tipo_sexo" id="tipo_sexo" class="form-control" placeholder="Masculino o Femenino u Otro" aria-describedby="helpId">
                        </div>
                    </div>
