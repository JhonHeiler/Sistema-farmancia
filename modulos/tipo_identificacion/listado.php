...
$sql_cantidad = "SELECT count(*) as cantidad FROM tipo_identificacion";
		...
		<table id="table" class="table table-striped" >
			...
			<tbody>
		        ...
		        if (isset($_GET['tipo_identificacion_id']) == true &&  $_GET['tipo_identificacion_id']  != "") {
		            $filtros .= " AND t.tipo_identificacion_id = '$_GET[tipo_identificacion_id]' ";
		        }


		         if (isset($_GET['nombre_tipo_identificacion']) == true &&  $_GET['nombre_tipo_identificacion']  != "") {
		             $filtros .= " AND t.nombre_tipo_identificacion = '$_GET[nombre_tipo_identificacion]' ";
		         }
					...
					<tr>
						...
						<td class='acciones'>
	                    <a href='javascript:;' class='mostrar'  onclick='mostrar(\"$rw[tipo_identificacion_id]\")'>
	                        <i class='fas fa-eye'></i>
	                    </a>
	                    <a href='javascript:;' class='eliminar' onclick='eliminar(\"$rw[tipo_identificacion_id]\")'>
	                        <i class='fas fa-trash'></i>
	                    </a>
	                    <a href='javascript:;' class='modificar' onclick='modificar(\"$rw[tipo_identificacion_id]\")'>
