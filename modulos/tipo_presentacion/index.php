...
<body>
                    ...
                    <br>
                     ...
                     <div class="form-group row">
                        ...
                        <div class="col-sm-12 col-md-8">
                            <input type="text" name="nombre_tipo_presentacion" id="" class="form-control" placeholder="" aria-describedby="helpId">
                        </div>
                    </div>
        ...
        <div class="card" style="width:750px;margin:auto">
            ...
            <div class="card-body" style="border:0px red solid">
                <form action="guardar.php" method="post" id="formulario" autocomplete="off">
                    ...
                    <input type="hidden" name="id_tipo_presentacion" id="id_tipo_presentacion" />
                    ...
                    <div class="form-group row">
                        <div class="col-sm-12 col-md-4">
                            <label for="nombre_tipo_presentacion ">NOMBRE PRESENTACION*</label>
                        </div>
                        <div class="col-sm-12 col-md-8">
                            <input type="text" name="nombre_tipo_presentacion" id="nombre_tipo_presentacion" class="form-control" placeholder="" aria-describedby="helpId">
                        </div>
                    </div>
 ...
 <script type="text/javascript">
        ...
        $("#btn-guardar").click(function() {
            ...
            $.post("?modulo=tipo_presentacion&accion=agregar", parametros, function(respuesta) {
...
//____________________BOTON MODIFICAR_________________________________
        ...
        $("#btn-modificar").click(function() {
            if (confirm("¿Desea modificar el registro?")) {
                var parametros = $("#formulario").serialize();
                $.post("?modulo=tipo_presentacion&accion=modificar", parametros, function(respuesta) {
                    //jQuery.parseJSON convertir la respuesta en JSON en un arreglo asociativo
        ...
        function mostrar(id_tipo_presentacion) {
            $("#titulo").html("Mostrar facturada");
            var parametros = "id_tipo_presentacion=" + id_tipo_presentacion;
            $.get("?modulo=tipo_presentacion&accion=cargar-datos", parametros, function(respuesta) {
              console.log(respuesta);
                ...
                $("#nombre_tipo_presentacion").val(r.nombre_tipo_presentacion);
        ...
        function eliminar(id_tipo_presentacion) {
            if (confirm("¿Realmente desea eliminar el registro?")) {
                var parametros = "id_tipo_presentacion=" + id_tipo_presentacion;
                $.post("?modulo=tipo_presentacion&accion=eliminar", parametros, function(respuesta) {
                    var r = jQuery.parseJSON(respuesta);
                    alert(r.mensaje);
                    if (r.error == false) {
                        cargar_listado();
        ...
        function modificar(id_tipo_presentacion) {
        ...
        $("#btn-buscar").click(function() {
         ...
         function cargar_listado() {
            ...
            $("#listado").load("?modulo=tipo_presentacion&accion=listar", parametros);
        }
