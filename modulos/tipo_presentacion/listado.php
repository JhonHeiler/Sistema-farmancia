...
$sql_cantidad = "SELECT count(*) as cantidad FROM tipo_presentacion";
		...
		<table id="table" class="table table-striped" >
			...
			<tbody>
		        ...
		        if (isset($_GET['id_tipo_presentacion']) == true &&  $_GET['id_tipo_presentacion']  != "") {
		            $filtros .= " AND p.id_tipo_presentacion = '$_GET[id_tipo_presentacion]' ";
		        }


		         if (isset($_GET['nombre_tipo_presentacion']) == true &&  $_GET['nombre_tipo_presentacion']  != "") {
		             $filtros .= " AND p.nombre_tipo_presentacion = '$_GET[nombre_tipo_presentacion]' ";
		         }
                    ...
                    p.nombre_tipo_presentacion as nombre                                  
					FROM tipo_presentacion p
					WHERE TRUE $filtros
					...
					<tr>
						...
						<td class='acciones'>
	                    <a href='javascript:;' class='mostrar'  onclick='mostrar(\"$rw[id_tipo_presentacion]\")'>
	                        <i class='fas fa-eye'></i>
	                    </a>
	                    <a href='javascript:;' class='eliminar' onclick='eliminar(\"$rw[id_tipo_presentacion]\")'>
	                        <i class='fas fa-trash'></i>
	                    </a>
	                    <a href='javascript:;' class='modificar' onclick='modificar(\"$rw[id_tipo_presentacion]\")'>
